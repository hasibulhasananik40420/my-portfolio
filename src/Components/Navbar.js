...
const Navbar = () => {
  return (
    <div className='fixed top-0 z-10 w-full' style={{
      ...
      <div class="navbar ">
        <div class="navbar-start">
          ...
          <a class=" text-3xl font-mono ml-12">Hasi<span className='text-3xl text-[#F5C32C] font-mono'>bul_</span><span>Porifolio</span></a>
        </div>
        <div class="navbar-center hidden lg:flex">
          <ul class=" text-white menu menu-horizontal p-0">
            ...
            <li><a href={resume} download className='btn px-10 py-3 btn-outline btn-warning mr-4'>Resume</a></li>
          </ul>
        </div>
